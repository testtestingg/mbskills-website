    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-balance mb-6 animate-fade-in-heading">
          <span className="text-foreground">Développez vos</span>
          <br className="sm:hidden" />
          <span className="inline-flex items-center justify-center flex-nowrap gap-2 mt-4 sm:mt-6 md:mt-8">
            <span className="text-foreground">Compétences</span>
            <RotatingText
              texts={["Tech", "Numériques", "Professionnelles", "Futurées", "Spécialisées"]}
        ...
        <p className="text-base sm:text-xl md:text-2xl text-white text-balance max-w-sm sm:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0 animate-fade-in-subheading font-light">
          MBSkills aide les professionnels à développer leurs compétences technologiques avec des formations pratiques, certifiantes et adaptées au marché de l'emploi.
        </p>
          ...
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                <div className="text-base sm:text-lg font-semibold">Développement Web</div>
                                <div className="text-base sm:text-lg font-semibold">Développement avec l'IA</div>
                <div className="text-base sm:text-lg font-semibold">Applications Mobile</div>
                <div className="text-base sm:text-lg font-semibold">Intelligence Artificielle</div>
          ...
          <div className="relative overflow-hidden w-full max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-6 opacity-60 animate-slide-left-mobile">
              <div className="flex items-center gap-6 whitespace-nowrap">
                ...
                <div className="text-sm font-semibold">Développement avec l'IA</div>
                <div className="text-sm font-semibold">Applications Mobile</div>
                <div className="text-sm font-semibold">Intelligence Artificielle</div>
