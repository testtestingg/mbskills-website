    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in-subheading">
        ...
        <div className="flex flex-col items-center gap-2 sm:hidden">
          <span className="text-lg text-slate-300">Nos diplômés obtiennent</span>
          <span className="text-3xl font-bold bg-gradient-to-r from-[#04a3fe] to-[#122138] bg-clip-text text-transparent animate-pulse-glow">
            {counter}%
          </span>
          <span className="text-lg text-slate-300">de taux d'emploi</span>
        </div>

        {/* Desktop version - single line */}
        <div className="hidden sm:flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
          <span className="text-xl md:text-2xl text-slate-300">Nos diplômés obtiennent</span>
          <span className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#04a3fe] to-[#122138] bg-clip-text text-transparent animate-pulse-glow">
            {counter}%
          </span>
          <span className="text-xl md:text-2xl text-slate-300">de taux d'emploi</span>
        </div>
      </div>
        ...
        <div className="relative w-full aspect-video bg-white/5 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/20 shadow-2xl group cursor-pointer hover:bg-white/10 hover:border-white/30 transition-all duration-500">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="text-center space-y-2 mt-24 sm:mt-32">
              <p className="text-white/70 text-xs sm:text-base font-medium">Découvrez nos formations</p>
            </div>
          </div>
