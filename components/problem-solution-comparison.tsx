...
export function ProblemSolutionComparison() {
  ...
  const comparisons = [
    {
      icon: Phone,
      channel: "Appels Téléphoniques",
      problem: "70% des appels vont vers la messagerie vocale",
      solution: "95% des appels répondus instantanément",
    },
    {
      icon: MessageSquare,
      channel: "Chat Site Web",
      problem: "Temps de réponse de 4+ heures",
      solution: "Réponse instantanée",
    },
    {
      icon: MessageCircle,
      channel: "Messagerie Sociale",
      problem: "Temps de réponse de 4+ heures",
      solution: "Réponses instantanées sur tous les réseaux",
    },
    {
      icon: Car,
      channel: "Consultations",
      problem: "Planification manuelle, opportunités manquées",
      solution: "Planifie les consultations via téléphone, réseaux ou chat",
    },
    {
      icon: Calendar,
      channel: "Réservations de Formation",
      problem: "Planification de formation retardée",
      solution: "Réservation et planification instantanées",
    },
    {
      icon: Wrench,
      channel: "Questions sur les Programmes",
      problem: "Devis et questions lentes sur les programmes",
      solution: "Vérifie instantanément les disponibilités et donne les prix",
    },
  ]
    ...
    <section ref={sectionRef} className="relative py-16 sm:py-24">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto">
          Voyez ce qui se passe lorsqu'un étudiant contacte votre centre de formation après les heures d'ouverture
        </p>
      </div>
                  ...
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-left py-6 px-6">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-red-50 border-l-4 border-red-500">
                        <span className="text-red-600 font-semibold">Sans MBSkills</span>
                      </div>
                    </th>
                    <th className="text-left py-6 px-6">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-50 border-l-4 border-green-500">
                        <span className="text-green-600 font-semibold">Avec MBSkills</span>
                      </div>
                    </th>
                  </tr>
                </thead>
          ...
          <div className="md:hidden space-y-4">
            ...
            <div className="backdrop-blur-sm bg-slate-50/50 rounded-xl border border-slate-200 overflow-hidden mt-6">
              <div className="p-4 border-b border-slate-200 bg-slate-50">
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">Impact Annuel</span>
              </div>
              <div className="grid grid-cols-2 divide-x divide-slate-200">
