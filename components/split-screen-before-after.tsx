          ...
          <div className="grid lg:grid-cols-[40%_1fr] gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                <Image
                  src="/images/tech-training-center.jpg"
                  alt="Centre de formation technologique moderne"
                  fill
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200 mb-4">
                <span className="text-orange-600 font-semibold text-sm uppercase tracking-wide">MBSkills Pro</span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 lg:mb-12 text-balance">
                <span className="text-slate-900">Ne manquez jamais un prospect avec</span>{" "}
              ...
              <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Répondez instantanément aux demandes des étudiants via WhatsApp, Facebook Messenger et Instagram DMs. Ne laissez jamais un étudiant attendre.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-slate-900 text-xl mb-3">Appels Téléphoniques 24/7</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Gérez un nombre illimité d'appels entrants 24h/24 et 7j/7. Répondez aux questions, planifiez des séances et qualifiez les prospects même après les heures.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-slate-900 text-xl mb-3">Widget Chat Site Web</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Engagez les visiteurs dès leur arrivée sur votre site. Fournissez des réponses instantanées sur les programmes, les tarifs et la disponibilité en temps réel.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Répondez automatiquement aux demandes par email et SMS. Maintenez les conversations fluides sur chaque canal préféré par vos étudiants.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-slate-900 text-xl mb-3">Qualification des Prospects</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Identifiez automatiquement les étudiants à forte intention, capturez les plages budgétaires, les préférences de programme et les détails d'expérience avant l'intervention de votre équipe.
                  </p>
                </div>

                <div>
                  <h3 className="font-bold text-slate-900 text-xl mb-3">Réservation Instantanée</h3>
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Planifiez des séances d'information, des inscriptions et des consultations automatiquement. Synchronisez avec votre calendrier et envoyez des confirmations instantanément.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200 mb-4">
                  ...
                  <span className="text-orange-600 font-semibold text-sm uppercase tracking-wide">Messagerie</span>
                </div>

                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
                  <span className="text-slate-900">Répondez à chaque message</span>{" "}
                  <span className="bg-gradient-to-r from-orange-600 via-orange-500 to-red-500 bg-clip-text text-transparent">
                    instantanément, 24/7
                  </span>
                </h2>
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  MBSkills Pro gère toutes vos conversations WhatsApp, Messenger et Instagram DM automatiquement.
                  Ne manquez jamais un prospect, même après les heures ou pendant les périodes chargées.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Répondez instantanément aux demandes des étudiants via WhatsApp, Facebook Messenger et Instagram DMs. Gérez un nombre illimité de conversations simultanément avec des réponses professionnelles et cohérentes qui planifient des séances et qualifient les prospects automatiquement.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Capturez des informations complètes sur les étudiants, y compris les préférences de programme, la plage budgétaire, les détails d'expérience et les coordonnées. Chaque conversation est enregistrée avec un historique complet, donc votre équipe pédagogique a toujours le contexte.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-700 leading-relaxed">
                      Fournissez des réponses cohérentes et professionnelles qui améliorent la réputation de votre centre de formation. Les étudiants reçoivent des réponses instantanées et utiles qui semblent personnelles et professionnelles, créant la confiance dès le premier message.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[600px] overflow-hidden">
                      <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-2 lg:py-3 flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-slate-400 text-[9px] sm:text-[10px] lg:text-xs">Étudiant</div>
                        </div>
                      </div>
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-60px)] lg:h-[calc(100%-80px)] overflow-hidden">
                        <div className="mb-2">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Bonjour, je suis intéressé par votre formation en développement web
                            </p>
                        ...
                        <div className="mb-2 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Nous sommes actuellement fermés. Heures d'ouverture : 9h - 18h. Nous répondrons demain !
                            </p>
                        ...
                        <div className="mb-2">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">Bonjour ?</p>
                        ...
                        <div className="flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[90%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Nous sommes actuellement fermés. Heures d'ouverture : 9h - 18h.
                            </p>
                    ...
                    <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[700px] overflow-hidden">
                      <div className="bg-[#0a5c4a] rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-2 lg:py-3 flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-slate-300 text-[9px] sm:text-[10px] lg:text-xs">Étudiant</div>
                        </div>
                      </div>
                      <div className="bg-[#0d1418] rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-60px)] lg:h-[calc(100%-80px)] overflow-y-auto scrollbar-hide">
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Bonjour Jean ! Merci pour votre intérêt dans notre formation en développement web. Je serais ravi de planifier une séance d'information. 💻
                            </p>
                            <p className="text-slate-300 text-[8px] lg:text-xs mt-0.5 text-right">19:00</p>
                          </div>
                        </div>
                        ...
                        <div className="mb-2 lg:mb-3">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Ce serait super ! Quand êtes-vous disponible ?
                            </p>
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              J'ai des disponibilités demain à 10h, 14h, ou 16h. Quelle heure vous convient le mieux ?
                            </p>
                        ...
                        <div className="mb-2 lg:mb-3">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              14h me convient parfaitement. Quel est le prix ?
                            </p>
                        ...
                        <div className="mb-2 lg:mb-3 flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Parfait ! Je vous ai réservé pour 14h demain. La formation en développement web est de 3 500€. Formation de 16 semaines avec certification. Options de financement ?
                            </p>
                        ...
                        <div className="mb-2 lg:mb-3">
                          <div className="bg-[#1f2c34] rounded-lg rounded-tl-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Oui s'il vous plaît ! Acceptez-vous le CPF ?
                            </p>
                        ...
                        <div className="flex justify-end">
                          <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-2 inline-block max-w-[85%]">
                            <p className="text-white text-[9px] sm:text-[10px] lg:text-sm leading-snug">
                              Nous acceptons le CPF ! Quel est votre solde CPF ? Je peux vous donner une estimation instantanée. 💰
                            </p>
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                      <div className="bg-slate-900 rounded-[2rem] sm:rounded-[2.5rem] p-2 sm:p-3 lg:p-4 shadow-2xl border-[6px] sm:border-8 border-slate-800 aspect-[9/19.5] lg:aspect-auto lg:h-[700px] overflow-hidden">
                        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-t-xl sm:rounded-t-[1.25rem] px-3 py-4 sm:py-5 lg:py-8 text-center border-b border-slate-700">
                          ...
                          <div className="text-white font-bold text-xs sm:text-sm lg:text-lg mb-1">Sarah khalil</div>
                        ...
                        <div className="bg-slate-900 rounded-b-xl sm:rounded-b-[1.25rem] p-2 sm:p-3 lg:p-4 h-[calc(100%-140px)] lg:h-[calc(100%-200px)] overflow-hidden flex flex-col">
                          ...
                          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-2 lg:p-3 mb-2 lg:mb-3">
                            ...
                            <div className="space-y-1 text-[8px] sm:text-[9px] lg:text-xs">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="text-white font-medium">3 sonneries</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-slate-400">Statut</span>
                                <span className="text-red-400 font-semibold">Sans réponse</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-2 lg:p-3 mb-2 lg:mb-3">
                            ...
                            <div className="text-slate-400 text-[8px] sm:text-[9px] lg:text-xs italic leading-relaxed">
                              "Bonjour, vous avez atteint MBSkills. Nous sommes actuellement fermés. Veuillez laisser un message..."
                            </div>
                          </div>
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-2 sm:p-3 lg:p-4 border border-slate-700/50">
                          ...
                          <div className="space-y-2 lg:space-y-3 text-[8px] sm:text-[9px] lg:text-xs">
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-orange-400 font-semibold mb-0.5">MBSkills</div>
                              <div className="text-slate-300 leading-relaxed">
                                "La formation en data science est disponible. Souhaitez-vous planifier une séance d'information ?"
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-blue-500">
                              ...
                              <div className="text-slate-300 leading-relaxed">
                                "Oui s'il vous plaît ! Quels horaires avez-vous cette semaine ?"
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-orange-400 font-semibold mb-0.5">MBSkills</div>
                              <div className="text-slate-300 leading-relaxed">
                                "J'ai demain à 11h, jeudi à 15h, ou vendredi à 10h..."
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-blue-500">
                              <div className="text-blue-400 font-semibold mb-0.5">Sarah</div>
                              <div className="text-slate-300 leading-relaxed">
                                "Jeudi à 15h me convient parfaitement. Quel est le tarif pour ce programme ?"
                              </div>
                            </div>
                            <div className="bg-slate-900/50 rounded-lg p-2 border-l-2 border-orange-500">
                              <div className="text-orange-400 font-semibold mb-0.5">MBSkills</div>
                              <div className="text-slate-300 leading-relaxed">
                                "La formation en data science est tarifée à 4 500€. Programme de 20 semaines avec certification. Souhaitez-vous discuter des options de financement ?"
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border-2 border-orange-500/40 rounded-xl p-2 lg:p-3 shadow-lg shadow-orange-500/10">
                          ...
                          <div className="grid grid-cols-2 gap-1.5 text-[8px] sm:text-[9px] lg:text-xs">
                            <div className="bg-slate-900/40 rounded-lg p-1.5 border border-orange-500/20">
                              <div className="text-orange-300 font-semibold">Forte Intention</div>
                              <div className="text-slate-300">Prêt à s'inscrire</div>
                            </div>
                            <div className="bg-slate-900/40 rounded-lg p-1.5 border border-orange-500/20">
                              <div className="text-orange-300 font-semibold">4-5k€</div>
                              <div className="text-slate-300">Plage budgétaire</div>
                            </div>
                            <div className="bg-slate-900/40 rounded-lg p-1.5 border border-orange-500/20 col-span-2">
                              <div className="text-orange-300 font-semibold">Data Science • Python • Machine Learning</div>
                              <div className="text-slate-300">Préférences de programme</div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                >
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200 mb-4">
                    ...
                    <span className="text-orange-600 font-semibold text-sm uppercase tracking-wide">Appels Vocaux</span>
                  </div>

                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
                    <span className="text-slate-900">Répondez à chaque appel</span>{" "}
                    <span className="bg-gradient-to-r from-orange-600 via-orange-500 to-red-500 bg-clip-text text-transparent">
                      instantanément, 24/7
                    </span>
                  </h2>
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Ne manquez jamais un prospect avec l'automatisation téléphonique intelligente qui gère un nombre illimité d'appels 24h/24 et 7j/7. Planifiez des séances, répondez aux questions et qualifiez les prospects automatiquement.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Répondez à chaque appel instantanément avec des conversations naturelles qui comprennent vos programmes, tarifs et disponibilités. Ne perdez jamais un étudiant à cause de la messagerie vocale.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Planifiez des séances, répondez aux questions sur les programmes, fournissez les tarifs et gérez les demandes de financement à travers des conversations téléphoniques naturelles qui semblent complètement humaines.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-slate-700 leading-relaxed">
                        Obtenez des informations en temps réel sur chaque appel, y compris l'intention de l'étudiant, la plage budgétaire et les préférences de programme. Votre équipe pédagogique reçoit des prospects chauds prêts à s'inscrire.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div ref={serviceSectionRef} className="mt-12 lg:mt-16 pt-12 lg:pt-16 border-t border-slate-200">
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  ...
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
                    <span className="text-slate-900">Automatisez les</span>{" "}
                    <span className="bg-gradient-to-r from-orange-600 via-orange-500 to-red-500 bg-clip-text text-transparent">
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Gérez les inscriptions aux programmes et les demandes d'informations automatiquement sur tous vos canaux de vente - site web, téléphone et réseaux sociaux. MBSkills Pro gère les inscriptions, répond aux questions sur les programmes et traite les commandes de manière transparente, le tout personnalisé selon les opérations de votre centre de formation.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Inscriptions aux Formations</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        MBSkills Pro planifie automatiquement les inscriptions et envoie des confirmations sur tous les canaux - site web, téléphone et réseaux sociaux, personnalisé selon votre flux de travail
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Questions sur les Programmes</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Gestion des Inscriptions</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Suivi des Étudiants</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                      ...
                      <div className="bg-white rounded-3xl overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-red-500 px-6 py-4 flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="text-white font-bold text-lg">mbskills_pro</div>
                            <div className="text-orange-100 text-sm">Actif maintenant</div>
                          </div>
                        </div>
                        ...
                        <div className="p-6 space-y-4 bg-slate-50 h-[500px] overflow-hidden">
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">Bonjour, j'ai besoin d'informations sur vos formations</p>
                              </div>
                            ...
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Je serais ravi de vous aider ! Quel type de formation vous intéresse ? Nous avons des places disponibles cette semaine.
                                </p>
                              </div>
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">
                                  Formation en développement web. Avez-vous des options de financement ?
                                </p>
                              </div>
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Oui ! Nous acceptons le CPF. Je peux vous réserver pour jeudi à 14h et inclure les informations sur le financement. Total : 3 500€
                                </p>
                              </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">Parfait ! Puis-je obtenir le programme détaillé ?</p>
                              </div>
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Je vous ai envoyé le programme complet. Votre inscription est confirmée pour jeudi à 14h. À très bientôt !
                                </p>
                              </div>
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:-rotate-6 w-full max-w-[380px]">
                      <div className="bg-white rounded-3xl overflow-hidden">
                        <div className="bg-gradient-to-r from-orange-500 to-red-500 px-6 py-4 flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <div className="text-white font-bold text-lg">MBSkills Pro</div>
                            <div className="text-orange-100 text-sm">Actif maintenant</div>
                          </div>
                        </div>
                        ...
                        <div className="p-6 space-y-4 bg-slate-50 h-[500px] overflow-hidden">
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">Quelle est la certification pour la formation IA ?</p>
                              </div>
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  La formation IA a une certification reconnue par l'industrie, valide jusqu'en mars 2026 ! Historique complet des services disponible !
                                </p>
                              </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">Combien d'heures par semaine ?</p>
                              </div>
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  15 heures par semaine avec un historique complet de formation par des instructeurs certifiés. Souhaitez-vous planifier une séance d'information ?
                                </p>
                              </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-sm">
                                <p className="text-slate-700 text-sm">Y a-t-il un soutien après la formation ?</p>
                              </div>
                          ...
                          <div className="flex gap-3 justify-end">
                            <div className="flex-1 flex flex-col items-end">
                              <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl rounded-tr-none px-4 py-3 shadow-sm max-w-[85%]">
                                <p className="text-white text-sm">
                                  Oui ! Nous offrons un soutien carrière complet. Quel est votre parcours professionnel ? Nous pouvons vous donner une estimation instantanée.
                                </p>
                              </div>
                ...
                >
                  ...
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance">
                    <span className="text-slate-900">Gérez les Demandes</span>{" "}
                    <span className="bg-gradient-to-r from-orange-600 via-orange-500 to-red-500 bg-clip-text text-transparent">
                      Automatiquement
                    </span>
                  </h2>
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Arrêtez de perdre du temps sur les questions répétitives. MBSkills Pro répond instantanément aux questions courantes sur les certifications, les horaires, le financement et les tarifs tout en qualifiant les étudiants sérieux - sur votre widget de site web, les appels téléphoniques et les canaux de réseaux sociaux, le tout personnalisé selon les besoins spécifiques de votre centre de formation.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Réponses Instantanées</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        MBSkills Pro répond à 50+ questions courantes sur les certifications, les horaires, le financement et les tarifs instantanément sur votre site web, téléphone et réseaux sociaux
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Qualifiez les Prospects</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Filtrez automatiquement les étudiants sérieux des navigateurs en posant les bonnes questions personnalisées pour votre centre de formation
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Gagnez du Temps</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Arrêtez de répondre aux mêmes questions répétitivement - laissez MBSkills Pro gérer les demandes d'information
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-bold text-slate-900 text-lg">Disponibilité 24/7</h3>
                      </div>
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
